...
def game_intro():
    ...
    while intro:
        ...
        message_to_screen("Press P to play or Q to Exit ", white, 150, "med")
        message_to_screen("Created by - Ambuj Dhakad ", red, 220, "med")
        pygame.display.update()
        clock.tick(8)
...
def gameLoop():
    ...
    while not gameExit:
        while gameOver == True:
            ...
            message_to_screen("Press C to Continue or  Q to Quit", white, y_displace=50,size="med")
            pygame.display.update()
